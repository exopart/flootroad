...
🚪 /start",
    'increase_wallet_request_message'=>"💳 درخواست ( Increased inventory )
...
<b>به دلیل عدم مطابقت مبلغ تراکنش رد شد</b>",
    'agent_discount_settings'=>"Discount managementی نماینده AGENT-NAME"
];

$buttonValues = [
    'bot_reports'=>"📉 General statistics of the robot",
    'message_to_user'=>"📞 Private message",
    'user_reports'=>"🔑 User data",
    'admins_list'=>"👤 List of admins",
    'increase_wallet'=>"💵 Increased inventory",
    'decrease_wallet'=>"💸 Reduced inventory",
    'create_account'=>"⌨️ Creating a mass account",
    'ban_user'=>"❌ Blocking the user",
    'unban_user'=>"✅ Freeing the user",
    'server_settings'=>'🚦Server management and settings',
    'categories_settings'=>'🗂 Category management',
    'plan_settings'=>'🪣 Management of plans',
    'discount_settings'=>"🎁 Discount management",
    'main_button_settings'=>"🕹 Buttons management",
    'gateways_settings'=>'💳 Port and channel settings',
    'bot_settings'=>'⚙️ Robot settings',
    'tickets_list'=>'📪 Tickets',
    'message_to_all'=>"📨 Sending a public message",
    'forward_to_all'=>"📨 The message is universal.",
    'back_to_main'=>'⤵️ Go back to the main menu ',  
    'cart_to_cart'=>"💳 Card to card.",
    'now_payment_gateway'=>"💳 PortalNowPayment",
    'zarinpal_gateway'=> "💳 Portal Zarin pal",
    'nextpay_gateway'=>"💳 Portal Next P",
    'weswap_gateway'=>"💳 Portalارزی ریالی",
    'approve' => 'تایید ✅',
    'approved' => 'تایید شد',
    'decline' => 'عدم تایید ❌',
    'declined' => 'رد شد',
